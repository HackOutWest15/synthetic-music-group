...
class AllNotes:
    def __init__(self):
        ...
        C3= pygame.mixer.Sound("Sounds/Glaspling/C4.wav")
        C3s = pygame.mixer.Sound("Sounds/Glaspling/C4#.wav")
        D3 = pygame.mixer.Sound("Sounds/Glaspling/D4.wav")
        D3s = pygame.mixer.Sound("Sounds/Glaspling/D4#.wav")
        ...
        F2 = pygame.mixer.Sound("Sounds/Glaspling/F3.wav")
        F2s = pygame.mixer.Sound("Sounds/Glaspling/F3#.wav")
        G2 = pygame.mixer.Sound("Sounds/Glasplingv/G3.wav")
        G2s = pygame.mixer.Sound("Sounds/Glaspling/g3#.wav")
        A2 = pygame.mixer.Sound("Sounds/Glaspling/A3.wav")
        A2s = pygame.mixer.Sound("Sounds/Glaspling/A3#.wav")
        B2 = pygame.mixer.Sound("Sounds/Glaspling/B3.wav")
